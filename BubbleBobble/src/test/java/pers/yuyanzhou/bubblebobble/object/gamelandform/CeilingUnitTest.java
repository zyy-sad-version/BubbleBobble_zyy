...
class CeilingUnitTest {
    private LandformsUnit ceiling;
    ...
    void setUp() {
        ...
        ceiling = new CeilingUnit(normalLevel,1,1);
    }
    ...
    @Test
    void collideWith() {
        ceiling.collideWith(gravity);
        if(ceiling.isOverlaps(gravity)){
    ...
    @Test
    void moveObject() {
        ceiling.moveObject(gravity);
        assertEquals(ceiling.getY()+ gravity.getHeight(),gravity.getY());
    }
}